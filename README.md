...
[circleci-url]: https://circleci.com/gh/nestjs/nest
  ...
  <p align="center">LiveMatch API</p>
    <p align="center">
...
```bash
$ npm install
$ adicionar todas as váriaveis de ambiente assim como no arquivo .env.example
$ npx prisma migrate resolve --applied "20221026002526_init" --preview-feature
$ npx prisma db push
```
